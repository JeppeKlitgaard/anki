...
notetypes-mathjax-preamble = MathJax Preamble
notetypes-mathjax-preamble-tooltip = Text in this field is loaded by all MathJax instances (browser, editor, during study) when they are initialised. This can be used to load MathJax packages (physics, mhchem, ...) and define aliases. You should not put anything here that will generate an output.
